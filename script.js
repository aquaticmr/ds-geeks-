const questions = [
  ...
  },
  {
      ...
      answers: [
          { text: "It is faster than binary search on sorted arrays", correct: false },
          { text: "It is always faster than binary search", correct: false },
          { text: "It can be used on both sorted and unsorted arrays", correct: true },
          { text: "It requires the array to be sorted", correct: false },
      ]
  },
  {
      question: "If you are looking for an element in an unsorted array of size 10 using linear search, what is the maximum number of comparisons needed?",
      answers: [
